...
?>
<h1 style="border-bottom: 2px solid #E1E1E1; margin-top: 20px; padding-bottom: 8px;"><?php echo __("Open Live Account") ?></h1>
...
<div class="left" style="width:450px;">
    ...
    <div class="wpcf7" id="wpcf7-f33-t1-o1">
        <form action="#" method="post" class="wpcf7-form">
            ...
            <p><input align="right" type="submit" onclick="alert('Form submitted'); window.location = 'live_Account'" value="Submit" class="wpcf7-form-control"/></p>
